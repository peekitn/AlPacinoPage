  ...
  return (
    ...
    <Timeline position="alternate-reverse">
      ...
      <TimelineItem>
        ...
        <TimelineContent className="timeline-text">A consagração de Al Pacino veio com o papel de Michael Corleone em The Godfather, dirigido por Francis Ford Coppola, mesmo sendo pouco conhecido na época. O sucesso lhe rendeu uma indicação ao Oscar e abriu caminho para mais nomeações ao longo dos anos 1970, incluindo por The Godfather Part II.
...
Nos anos 1980, sua carreira teve uma queda, com críticas negativas a alguns filmes, embora Scarface tenha se tornado marcante. Após o fracasso de Revolution, ele voltou ao teatro por alguns anos. Retornou ao cinema no fim da década com Sea of Love e recuperou o prestígio nos anos seguintes com filmes como Carlito’s Way, Heat, Donnie Brasco e The Recruit.</TimelineContent>
      </TimelineItem>
      <TimelineItem>
        <TimelineSeparator>
          <TimelineDot />
        </TimelineSeparator>
        <TimelineContent className="timeline-text">Al Pacino nunca se casou, mas tem quatro filhos: Julie Marie (com Jan Tarrant), os gêmeos Anton James e Olivia Rose (com Beverly D'Angelo) e Roman (com Noor Alfallah).

Ao longo da vida, teve vários relacionamentos, incluindo com Diane Keaton — sua colega em The Godfather — além de outras atrizes como Tuesday Weld, Jill Clayburgh e Lucila Polak, com quem manteve um relacionamento longo.</TimelineContent>
      </TimelineItem>
    </Timeline>
    </div>
  );
